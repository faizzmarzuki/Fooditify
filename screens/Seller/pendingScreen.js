...
import styles from '../../styles/screens/Seller/pendingScreen.style'
import styles3 from '../../styles/components/pendingSummary.style'
import styles2 from '../../styles/components/pendingPayment.style'
...
export default function PendingScreen({route}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.buttonMain} onPress={updateFinish}>
